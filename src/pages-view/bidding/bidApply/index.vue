 ...
 * @LastEditors: wmm
 * @LastEditTime: 2025-09-23 13:31:31
-->
<template>
  <app-page>
    <div class="view-section">
      <search-component 
        ...
        @search="onSearch"
        @reset="onReset"
        :cache="`search_bidding_bidApply_${userInfo.userId}`"
      >
      </search-component>
    </div>
    <table-section ref="tableSection">
      <div class="app-table-container" auto>
        ...
        <div class="app-table-body">
          <vxe-grid
            :id="`tb_bidding_bidApply_${userInfo.userId}`"
            :data="tableData"
          ...
          >
            ...
            <template #projectStatus="{ row }">
              <!-- <project-state :state="row.projectStatus"></project-state> -->
