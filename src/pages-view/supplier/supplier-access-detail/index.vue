      ...
      <el-tabs v-model="activeName" flex ref="tabs">
        <el-tab-pane name="jbxx">
          ...
          <sub-title title="企业资质">
            ...
            <template #buttons>
              <vxe-toolbar ref="qyzztoolbar" class="app-table-toolbar">
                <template #buttons>
                  <page-button v-if="editState && showBtn('addQyzz')" @click="papersForm={expireDate:'',autoRenewalFlag:1};visible.papersVisible=true;papersIndex=''" content="新增" type="text" style="margin-right: 36px;">
                    <template #img><svg-icon icon-class="addIcon" style="margin-right: 5px" /></template>
                  </page-button>
                </template>
                <template #tools>
          ...
          >
            ...
            <template #action="{row, rowIndex}">
              <page-button type="text" :disabled="!editState" @click="papersForm={...row};visible.papersVisible=true;papersIndex=rowIndex">编辑</page-button>
              <page-button type="text" :disabled="!editState" @click="form.qualificationsList.splice(rowIndex,1)">删除</page-button>
            </template>
          </vxe-grid>
    ...
    <template #custom>
      ...
      >
            ...
            <el-form-item label="到期日期">
              <div class="date-picker">
                <el-date-picker
                  ...
                  placeholder="请选择到期日期"
                  :picker-options="pickerOptions"
                  :disabled="!!papersForm.autoRenewalFlag"
                  clearable
                >
                </el-date-picker>
                <el-checkbox v-model="papersForm.autoRenewalFlag" :true-label="1" :false-label="0" @change="(e)=>papersForm.expireDate=null">长期有效</el-checkbox>
              </div>
            </el-form-item>
        ...
        <template #footer>
          ...
          <page-button @click="visible.papersVisible = false">取消</page-button>
        </template>
      </vxe-modal>
      <vxe-modal
        width="80%"
