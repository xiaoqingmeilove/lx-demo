...
export default {
  ...
  activated() {
    this.$tabs.activeTab.title = findMenuByCode(this.menuCode)?.title ?? '供应商准入';
    this.getList();
  },
  ...
  methods: {
    ...
    getList(callback) {
      ...
      apiBasic.getAccessList(this.condition, this.tablePage.currentPage, this.tablePage.pageSize).then(res => {
