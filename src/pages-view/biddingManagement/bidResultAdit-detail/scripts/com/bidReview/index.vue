                ...
                <div class="content-right">
                    ...
                    <div class="progress-box">
                        <div class="progress-item" v-for="item in progress" :key="item.title">
                            ...
                            <el-slider v-model="fileObj[item.field]" :min="0" :max="item.max" :disabled="true" @change="changeScore(item.field)"></el-slider>
                        ...
                        <div class="remark">
                            ...
                            <div class="progress-value total-score-value">
                                <el-input type="textarea" rows="3" v-model="fileObj.comment"  :disabled="true" placeholder="请输入备注"></el-input>
                            </div>
                        </div>
                    </div>
