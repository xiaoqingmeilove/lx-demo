...
export default {
    ...
    methods: {
        ...
        getBidReview(id) {
            ...
            let params = { id: id }
            apiBiddingManagement.getBidReview(params).then((res) => {
                if (res.code === 200) {
        ...
        saveScore(type) {
            ...
            apiBiddingManagement.putBidReview(this.fileObj).then((res) => {
                if (res.code === 200) {
        ...
        submitScore() {
            ...
            apiBiddingManagement.putScoreSubmit(params).then((res) => {
                if (res.code === 200) {
