<template>
    <div>
            ...
            <div class="content">
                <div class="content-left">
                    <div class="content-item-title"> 
                        ...
                        <div>
                            <el-button type="primary" plain size="mini" @click="onCellDbClick"><i class="el-icon-view"></i><span>查看详情</span></el-button>
        ...
        >
            <quotation-details :form-data = formData  :row-data = rowData></quotation-details>
        </vxe-modal>
    </div>
</template>
