...
import { ApiQuotation, ApiBuy, ApiBiddingManagement } from "@/apis";
...
import addUnconventional from "../tenderingApply-detail/scripts/com/addUnconventional/index.vue";
import timeline from "@/pages-components/timeline/index.vue";
import bidPreparation from "../tenderingApply-detail/scripts/com/bidPreparation/index.vue";
import supplierSelect from "../tenderingApply-detail/scripts/com/supplierSelect/index.vue";
import answeringQuestion from "../tenderingApply-detail/scripts/com/answeringQuestion/index.vue";
import bidTender from "./scripts/com/bidTender/index.vue";
import FilelistList from "@/Controls/filelist-list/index.vue";
import bizOperLog from "../tenderingApply-detail/scripts/com/bizOperLog/index.vue";
...
export default {
    ...
    data() {
        ...
        return {
            ...
            moment,
            activeName: 'tb',
            activeNameList: ['jbxx', 'cgmx', 'gys','czjl'],
            menuCode: "biddingManagement_myTender",
            fileBillTpye: "PA",
    ...
    methods: {
        ...
        activeNameChange(form) {
            ...
            switch (bizFlowStatus) {
                case '5':
                    this.activeName = 'zbwj';
                    this.activeNameList = ['jbxx', 'cgmx', 'zbwj', 'dyzx','tb','czjl'];
                    break;
                case '6':
                    this.activeName = 'tb';
                    this.activeNameList = ['jbxx', 'cgmx', 'zbwj', 'dyzx','tb','czjl'];
        ...
        tbSave() {
            this.tbSubmitFalg = false
            this.$refs.bidTender.tbSave();
        },
        tbSubmit() {
            this.tbSubmitFalg = true
            this.$refs.bidTender.tbSubmit();
        },
        publishBidding() {
        ...
        getDetail() {
            ...
            let id = this.id;
            apiBiddingManagement.getBidDetail({ id }).then((res) => {
                if (res.code === 200 && res.data) {
                    this.form = { ...res.data };
        ...
        async setColumn() {
            ...
            let data = {
                code: "detailList,detailList2,detailList3,detailList4,tabList",
            ...
            if (res.code === 200 && res.data && res.data) {
                ...
                this.detailListTb = [...res.data.detailList4.columns];
