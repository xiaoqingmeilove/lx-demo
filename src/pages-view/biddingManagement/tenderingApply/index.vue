        ...
        <div class="app-table-container" auto>
          <div class="app-table-header">
            ...
            <vxe-toolbar ref="toolbar" class="app-table-toolbar">
              <template #buttons>
                <page-button @click="$router.push('/biddingManagement/tenderingApply-edit')" type="text" style="margin-left: 36px;">
                    <template #img><svg-icon icon-class="addIcon" style="margin-right: 5px" />新建招标</template>
                </page-button>
              </template>
              <template #tools>
          ...
          <div class="app-table-body">
            ...
            >
              ...
              <template #billState="{ row ,column}">
                <state-pro :state="row.billState" source="bill_state"></state-pro>
              </template>
              ...
              <template #action="{ row }">
              <page-button type="text" v-if="row.billState>1" @click="onCellDbClick({row})">查看</page-button>
              <page-button type="text" v-else @click="onCellDbClick({row})">编辑</page-button>
            </template>
              <template #pager>
                <vxe-pager
