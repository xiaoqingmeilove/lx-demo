  ...
  <app-page>
    <div class="view-section">
      <search-component 
        ...
        @search="onSearch"
        @reset="onReset"
        :cache="`search_material_priceList_${userInfo.userId}`"
      >
      </search-component>
    </div>
      ...
      <div class="app-table-container" auto>
        <div class="app-table-header">
          ...
          <vxe-toolbar ref="toolbar" class="app-table-toolbar">
            <template #buttons>
              <page-button type="text" @click="$router.push({ path: `/material/priceList-detail/detail`})" style="margin-left: 36px;"><template #img><svg-icon icon-class="addIcon" style="margin-right: 5px" /></template>新增价目表</page-button>
        ...
        <div class="app-table-body">
          <vxe-grid
            :id="`tb_material_priceList_${userInfo.userId}`"
            :data="tableData"
