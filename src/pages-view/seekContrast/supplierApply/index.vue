  ...
  <app-page>
    <div class="view-section">
      <search-component
        ...
        :cache="`search_gysbj_${userInfo.userId}`"
        @search="onSearch"
        @reset="onReset"
      ></search-component>
    </div>
    <table-section ref="tableSection">
      <div class="app-table-container" auto>
        ...
        <div class="app-table-body">
          <vxe-grid
            :data="tableData"
            :id="`tb_gysbj_list_${userInfo.userId}`"
          ...
          >
            ...
            <template #enquiryState="{ row, rowIndex }">
              <project-state :state="row.enquiryState"></project-state>
            </template>
        </vxe-grid>
        </div>
