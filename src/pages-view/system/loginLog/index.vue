        ...
        <table-section ref="tableSection">
            <div class="app-table-container" style="padding:5px">
                <div class="app-table-header">
                    <sub-title high title="登录日志"></sub-title>
                ...
                <div class="app-table-body">
                    ...
                    >
                        ...
                        <template #operateType="{ row }">
                            <span v-if="row.operateType == 'login'">登入</span>
                            <span v-else>登出</span>
                        </template>
                        <template #status="{ row }">
                        ...
                        <template #clientType="{ row }">
                            <span v-if="row.clientType == 0">web</span>
                            <span v-else-if="row.clientType == 1">小程序</span>
                            <span v-else>系统内部</span>
                        </template>
                        <template #pager>
                        <vxe-pager
...
export default {
    ...
    getList() {
      ...
      apiSystem.getLoginLogListApi(data,token).then((res) => {
