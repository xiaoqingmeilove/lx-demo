  ...
  <div class="product-list-page">
    <div class="view-section" v-if="searchOptions && searchOptions.length">
      <search-component
        ...
        :cache="`search_purchasePool_product_list_${userInfo.userId}`"
        @search="onSearch"
        @reset="onReset"
      ></search-component>
    </div>
    <table-section>
      <div class="app-table-container" auto>
        ...
        <div class="app-table-body">
          <vxe-grid
            height="auto"
            :id="`tb_cgsq_purchasePool_product_list_${userInfo.userId}`"
            :data="tableData"
            :columns="columns"
            ref="productTable"
...
export default {
  ...
  props: {
    menuCode: {
      type: String,
      default: "buyingLead_purchaseNeedPool",
    },
  },
  computed: {
    ...mapState({
  ...
  methods: {
    ...
    getList() {
      ...
      apiContract.getRequirementsList(
          this.condition,
