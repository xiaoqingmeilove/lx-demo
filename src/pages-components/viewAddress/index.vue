      ...
      <table-section>
        <div class="app-table-container" auto>
          ...
          <div class="app-table-body">
            <vxe-grid
              height="auto"
              :id="`tb_viewAddress_list_${userInfo.userId}`"
              :data="tableData"
              :columns="columns"
              ref="productTable"
            ...
            >
              ...
              <template #defaultFlag="{row}">
                <span v-if="row.defaultFlag == 1" style="color: var(--special-button-bg);">是</span>
                <span v-else>否</span>
              </template>
          </vxe-grid>
          </div>
          <div class="app-table-footer" v-show="false">
            <vxe-pager
