  ...
  <div class="filelist-group">
    <div class="filelist-group-main">
      <div class="filelist-group-main-header" v-if="header">
        ...
        <upload-drag v-if="!readOnly" :height="'50px'" :showUploadIcon="false" style="margin-left: 12px;flex: 1" @success="onUploadSuccess"></upload-drag>
      </div>
            ...
            >
              <div>
                <a class="filelist-group-filelist-item-icon" @click="onItemImgClick(item)">
                  ...
                  <template v-else>
                    <img :src="require(`@/assets/fileIcon/${item.fileIcon}.png`)" />
                  </template>
                </a>
                <div class="file-info-content">
                  <div class="file-info-content-row">
                    ...
                    <svg-icon v-if="!readOnly && showEditName" icon-class="edit2" class="edit-filename" @click="onEditNameClick(item, index)"></svg-icon>
                  </div>
